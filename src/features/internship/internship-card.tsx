...
import { InternshipFD, OrganizationFD, StudentFD } from "@/data/fake-data";
                ...
                <CardContent className="font-thin mb-4 px-6 text-justify">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 mt-4 text-sm">
                        <div className="flex items-center gap-2">
                            ...
                            <span>{organization.country}, {organization.city}</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <GraduationCap className="w-4 h-4" />
                            <span>{internship.year} - {student.major}</span>
                        </div>
                        <div className="flex items-center gap-2">
