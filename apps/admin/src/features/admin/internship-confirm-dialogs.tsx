    ...
    switch (type) {
      ...
      case "all-drafts":
        return {
          ...
          description: "Êtes-vous sûr de vouloir supprimer tous les stages en attente ? Ils seront déplacés vers la section supprimés.",
      ...
      case "all-deleted":
        return {
          title: "Suppression définitive",
          description: "ATTENTION : Cette action est irréversible ! Tous les stages supprimés seront définitivement supprimés de la base de données et ne pourront pas être récupérés.",
          confirmText: "Supprimer définitivement",
        };
